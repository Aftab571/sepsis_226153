...
def main():
    ...
    df_admission,df_diagnosis,df_drugs,df_labs,df_vitals,df_diagnosis_features,df_demo,df_output,lst_weights, df_drugs_features = getPreprocessData('Graph',edge_merge='',grp_aggr='mean')  
